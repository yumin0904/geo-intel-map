...
> **현재 질적 갈래 잔여(2026-06-30)**: UNQUANTIFIABLE 케이스의 *Gemini 본문 서술* 라이브 확인만 남음
> (구조 8/8은 검증됨, 본문은 미확인). 시도했으나 **Gemini 무료티어 일일 한도(429)**로 보류 — 한도 회복 후 1케이스(예: `pla_taiwan_a2ad`) 라이브 → Van Evera 4검정 본문·증거배치·판정은연구자 확인.
